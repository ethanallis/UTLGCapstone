...
. Change and add the following lines to the named.conf.options file so that it looks similar:
+
image::namedconfoptionsmod1.jpg[Modified named.conf.options, align="center"]
