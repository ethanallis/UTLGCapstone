...
+
Open up `cmd` on your host machine where your vms are stored or use a different vm and try to ssh into the Wazuh Manager or Agent.
...
Once you've tried to ssh into the box after around 10-15 tries the ip you're using will end up being blocked by Wazuh.
