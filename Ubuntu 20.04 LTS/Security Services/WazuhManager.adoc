...
+
. Before trying to ssh into the box do `ping WAZUH-MANAGER-IP-ADDRESS` or `ping WAZUH-AGENT-IP-ADDRESS` and you'll get a response as long as you have connectivity.
+
